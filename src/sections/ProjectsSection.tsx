            ...
            >
              {/* Hero Image */}
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  {/* Removed gradient overlay to prevent washed out look in light mode */}
            ...
            >
              ...
              >
                ...
                <div className="relative h-96 overflow-hidden">
                  ...
                  />
                  {/* Dark gradient for consistent contrast */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent" />
                  <div className="absolute bottom-0 left-0 right-0 p-12">
                    <h2 className="text-4xl sm:text-5xl font-serif text-white mb-4">
                      {selectedProjectData.name}
                    </h2>
                    <p className="text-gray-200 font-light tracking-wide max-w-2xl">{selectedProjectData.description}</p>
                  </div>
                </div>
